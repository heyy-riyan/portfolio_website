      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915eff]">Mohd Abdul Wali</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am AI and Data Science Engineer from the Osmania
            University Hyderabad. <br className="sm:block hidden" />I am passionate about AI and Data Science, actively engaging in research projects, collaborating with peers, and participating in events and competitions.
