  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Mohammed Abdul Wali",
          from_email: form.email,
          to_email: "160420aid023@mjcollege.ac.in",
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="What you want to say? & you can also contact me on my social media handle->heyy_riyan_04"
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
          ...
          <div className="w-72 grid gap-x-6 gap-y-4 grid-cols-4 mx-2 ml-auto">
            {/* phone */}
            <a href="tel:+91 9701747154" target="_blank" rel="noreferrer">
              <img
                src={phone}
                alt={"phone"}
            ...
            {/* linkedin */}
            <a
              href="https://www.linkedin.com/in/mohammed-abdul-wali-farooqui/"
              target="_blank"
              rel="noreferrer"
            >
              <img
            ...
            {/* github */}
            <a
              href="https://github.com/heyy-riyan"
              target="_blank"
              rel="noreferrer"
            >
              <img
